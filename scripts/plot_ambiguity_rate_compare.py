...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--num_experts", type=int, default=6, help="dm-adapter MoE expert count.")
    parser.add_argument("--topk", type=int, default=2, help="dm-adapter MoE top-k experts.")
    parser.add_argument("--reduction", type=int, default=8, help="dm-adapter MoE bottleneck reduction.")
